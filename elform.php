...
if(isset($_POST['submit']))
{
	...
	$res = mysqli_query($con,"insert into el (uid,uname,fdate,tdate,purpose,hql,absphone,absaddr,c1,c2,c3,c4,dept) values('$uid','$uname','$fdate','$tdate','$purpose','$hql','$absphone','$absaddr','$c1','$c2','$c3','$c4','$dept')");
	if($res)
	{
		echo "<script>";
        echo "window.alert('Applied for Earned Leave Sucessfully')";
        echo "</script>" ;
